...
public:
    ...
    void setupUi(QMainWindow *QTGUIVideoTest1Class)
    {
        ...
        QTGUIVideoTest1Class->resize(957, 696);
        ...
        REPLAY->setGeometry(QRect(370, 530, 75, 23));
        ...
        label_2->setGeometry(QRect(10, 610, 54, 12));
        VideoPath = new QLabel(centralWidget);
        VideoPath->setObjectName(QStringLiteral("VideoPath"));
        VideoPath->setGeometry(QRect(70, 610, 421, 16));
    ...
    void retranslateUi(QMainWindow *QTGUIVideoTest1Class)
    {
        ...
        REPLAY->setText(QApplication::translate("QTGUIVideoTest1Class", "REPLAY", Q_NULLPTR));
        ...
        label_2->setText(QApplication::translate("QTGUIVideoTest1Class", "\345\267\262\351\200\211\350\247\206\351\242\221:", Q_NULLPTR));
        VideoPath->setText(QApplication::translate("QTGUIVideoTest1Class", "TextLabel", Q_NULLPTR));
